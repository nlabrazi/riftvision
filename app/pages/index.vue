      ...
      <div class="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex items-center flex-wrap gap-2.5 font-rajdhani font-bold text-xs">
          <button
            ...
            :class="status.isMock
              ? 'bg-purple-950/90 border-purple-500 text-purple-200 shadow-[0_0_12px_rgba(168,85,247,0.3)]'
              : 'bg-[#010a13] border-[#785a28]/60 text-[#c8aa6e] hover:border-[#c8aa6e] hover:text-[#f0e6d2]'"
          >
            <span
              class="w-2 h-2 rounded-full"
              :class="status.isMock ? 'bg-purple-400 animate-pulse' : 'bg-[#785a28]'"
            ></span>
      ...
      >
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div class="flex items-center gap-3.5">
            ...
            <div>
              <h2 class="text-sm font-bold font-cinzel tracking-wide flex items-center gap-2">
