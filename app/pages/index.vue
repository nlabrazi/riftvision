...
<template>
  <div
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            <div class="flex items-center gap-2">
              ...
              <span
                class="text-xs px-2 py-0.5 rounded-full font-mono bg-cyan-950/80 border border-cyan-800 text-cyan-400">v0.2.0</span>
            </div>
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto p-6 space-y-6">
      <!-- Status Banner -->
      <section data-testid="status-banner" class="rounded-2xl border p-4 transition-all shadow-xl" :class="{
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-2 text-xs">
            <div class="bg-slate-950/60 rounded-xl px-3 py-1.5 border border-slate-800 text-center">
              ...
              <div class="font-mono text-xs font-bold text-white">{{ gameData?.gameData?.gameMode || status.gameMode ||
                '—' }}</div>
            </div>
            <div class="bg-slate-950/60 rounded-xl px-3 py-1.5 border border-slate-800 text-center">
              <div class="text-[10px] uppercase text-slate-400 font-semibold">Latence</div>
              <div class="font-mono text-xs font-bold text-cyan-400">{{ status.latencyMs !== undefined ?
        ...
        <div v-if="lastError && status.status === 'DISCONNECTED'"
          class="mt-2 text-xs text-rose-400/90 font-mono bg-rose-950/40 p-2 rounded-lg border border-rose-900/50">
